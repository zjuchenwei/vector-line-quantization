...
class IVFBase {
 ...
 public:
  ...
  thrust::device_vector<void*> deviceListIndexPointers_;
    ...
    /// Device representation of all inverted list lambda pointers
  /// id -> data
  thrust::device_vector<void*> deviceListLambdaPointers_;

    /// Device representation of all inverted list lambda pointers
  /// id -> data
  thrust::device_vector<void*> deviceListConstPointers_;
  ...
  std::vector<std::unique_ptr<DeviceVector<unsigned char>>> deviceListIndices_;
   std::vector<std::unique_ptr<DeviceVector<unsigned char>>> deviceListLambdas_;
   std::vector<std::unique_ptr<DeviceVector<unsigned char>>> deviceListConsts_;
  ...
  std::vector<std::vector<unsigned char>> listOffsetToUserCode_;
};
